# InfraTales | APM Distributed Profiling – End-to-End Application Traces on AWS

**Production-ready reference architecture for application performance monitoring with distributed profiling on AWS.**

> **Application Performance Monitoring with continuous profiling, flame graph analytics, bottleneck detection, and performance regression testing**
